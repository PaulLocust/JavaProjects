...
public class Person implements Validatable, Serializable {
    ...
    public boolean validate() {
        return (!name.isEmpty()) && (height > 0) && (eyeColor != null);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(person.height, height) == 0 && Objects.equals(name, person.name) && eyeColor == person.eyeColor && hairColor == person.hairColor && nationality == person.nationality && Objects.equals(location, person.location);
    }
